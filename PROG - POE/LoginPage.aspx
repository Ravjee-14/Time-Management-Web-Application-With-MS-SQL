<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoginPage.aspx.cs" Inherits="PROG___POE.LoginPage" %>
        ...
        <div>
            <table class="auto-style1">
                ...
                <tr>
                    ...
                    <td class="auto-style3">&nbsp;</td>
                    <td class="auto-style2">
                        <asp:Button ID="BtnCreateAccount" runat="server" Text="Create New Account" Width="270px" OnClick="BtnCreateAccount_Click" />
                    </td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
